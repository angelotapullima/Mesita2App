...
class AgregarDetalleProducto extends StatefulWidget {
  ...
  const AgregarDetalleProducto({Key key, @required this.producto, @required this.idMesa}) : super(key: key);
                                ...
                                child: AnimatedBuilder(
                                    ...
                                    builder: (_, t) {
                                      return Row(
                                        ...
                                        children: [
                                          Text(
                                            (_controller.precioMuestra != '') ? 'S/. ${_controller.precioMuestra}' : 'S/. ${prod[0].productoPrecio}',
                                            style: TextStyle(
                                              color: Color(0XFF585858),
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                InkWell(
                                                  onTap: () {
                                                    _controller.changeCantidadPrecio(-1, prod[0].productoPrecio);
                                                  },
                                                  child: Container(
